...
\titleformat{\section}{\normalfont\large\bfseries\MakeUppercase}{ARTICLE \thesection:}{0.5em}{}
...
% References
\newcommand{\fullref}[2]{\mbox{\textbf{\MakeUppercase{Article \ref{#1}}, Section \ref{#2}}}}
\newcommand{\sectionref}[1]{\mbox{\textbf{\MakeUppercase{Article \ref{#1}}}}}
\newcommand{\subsectionref}[1]{\mbox{\textbf{Section \ref{#1}}}}
...
\title{Local Bylaws \\ MMWC/ CWA 7055}
\date{\today}
...
\begin{numberlist}
\item The approval of the Membership Committee (cite section), which is authorized to accept or reject membership on behalf of the union, subject to the right of the membership to overrule the decision of the Membership Committee
...
Any member may resign from membership in the Local in accordance with Article V, Section 4 of the CWA Constitution in writing to the Local. Members in good standing who retire or otherwise leave employment may have their membership continue with minimum dues, and may assume the status of at-large members. In the event any such person elects to become an associate member, the person shall lose voting privileges but shall not be required to pay dues.
...
Due notice of at least seven (7) days must be given prior to any union meeting. In the event a Special meeting is called for under the provisions of \subsectionref{special-meetings}, due notice may be shortened to three (3) days.

\subsection{Quorums}
The number constituting a quorum for Membership meetings shall be the number of members present. Special Meetings called for under the provisions of \subsectionref{special-meetings} shall have a quorum of no less than ten (10) members. A majority of the members of a work committee shall be the quorum for those bodies. For All Bargaining Unit meetings no quorum shall be necessary.
...
\subsection{Duties of Committees}
...
The formation of a Bylaws Committee as described in \sectionref{amendments} shall also be considered a temporary committee.
