...
\usepackage[letterpaper, top=3cm, right=4cm, bottom=3cm, left=4cm]{geometry}
\usepackage{
  booktabs,
  enumitem,
  microtype,
...
\fancyhf{}
\pagestyle{fancy}
\fancyfoot[L]{\scshape\nouppercase{MWWC \-- CWA, Local 7055 Union Bylaws}}
...
% Background Image
\backgroundsetup{scale = 1, angle = 0, opacity = 0.04,
...
\titleformat{\subsection}{\normalfont\large\bfseries}{Section \thesubsection:}{0.5em}{}
