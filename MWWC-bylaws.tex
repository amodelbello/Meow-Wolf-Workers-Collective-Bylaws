...
Any member may resign from membership in the Local in accordance with \href{https://cwa-union.org/for-locals/cwa-constitution\#A5}{Article V, Section 4} of the CWA Constitution in writing to the Local. Members in good standing who retire or otherwise leave employment may have their membership continue with minimum dues, and may assume the status of \textit{at-large members}. Any such person may also elect to become an associate member, and in so doing shall lose voting privileges but shall not be required to pay dues.
